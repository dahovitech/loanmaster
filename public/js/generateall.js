document.addEventListener('DOMContentLoaded', () => {
    ...
    const generateAllSpinner = generateAllButton.querySelector('.spinner-border');
    ...
    if (!generateAllButton || !buttonsSingle || !urlGetEntity || !urlTranslateText || !urlTranslateAllSave || !urlTranslateSave || !entityId || !defaultLanguage || !entityName) {
    ...
    generateAllButton.addEventListener('click', async (e) => {
        e.preventDefault();
        ...
        try {
            ...
            generateAllButton.textContent = 'Regenerate all';
        }
    });

    // Activez le bouton "generate-all" par défaut
    generateAllButton.disabled = false;
});