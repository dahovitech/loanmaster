...
class MediaController extends AbstractController
{
    ...
    #[Route('/media', name: 'app_admin_media')]
    public function show(Request $request, string $instance = 'default', string $homeFolder = ''): Response
    {
        $efParameters = $this->parameterBag->get('fm_elfinder');
        ...
        return $this->render("@admin/media.html.twig", $result['params']);
    }
    ...
    private function selectEditor(array $parameters, string $instance, string $homeFolder, string $assetsPath, string $formTypeId = null): array
    {
        ...
        $locale         = $parameters['locale'] ?: $this->parameterBag->get('locale');
